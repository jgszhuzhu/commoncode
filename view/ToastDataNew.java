...
import com.wineproject.activity.R;
 ...
 * @created 2012-8-30
 */
public class ToastDataNew extends Toast{
	
	private MediaPlayer mPlayer;
	private boolean isSound;
	
	public ToastDataNew(Context context) {
		this(context, false);
	}
	
	public ToastDataNew(Context context, boolean isSound) {
		super(context);
	 ...
	 * @return
	 */
	public static ToastDataNew makeText(Context context, CharSequence text, boolean isSound) {
		ToastDataNew result = new ToastDataNew(context, isSound);
